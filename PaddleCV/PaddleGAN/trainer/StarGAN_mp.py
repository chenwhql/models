...
class StarGAN(object):
    ...
    def build_model(self):
        ...
        place = fluid.CUDAPlace(gpu_id) if self.cfg.use_gpu else fluid.CPUPlace()
        ...
        if self.cfg.use_gpu and num_trainers > 1:
            dist_utils.prepare_for_multi_process(exe, build_strategy, gen_trainer.program)
            dist_utils.prepare_for_multi_process(exe, build_strategy, dis_trainer.program)
